...
const Ferrofluid: React.FC<FerrofluidProps> = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      type Cleanable = { remove?: () => void; destroy?: () => void };
      const callIfFn = (obj: Cleanable | null, key: "remove" | "destroy") => {
        const fn = obj && obj[key];
        if (typeof fn === "function") {
          fn.call(obj);
        }
      };
      callIfFn(programRef.current as Cleanable | null, "remove");
      callIfFn(geometryRef.current as Cleanable | null, "remove");
      callIfFn(meshRef.current as Cleanable | null, "remove");
      callIfFn(rendererRef.current as Cleanable | null, "destroy");
